...
de una operación cuántica. La CP es una condición más robusta  \cpnote{No entiendo 
ese adjetivo acá}
a la de la positividad y que, en el contexto de la
mecánica cuántica y los sistemas abiertos, asegura que, aún 
cuando el sistema principal se encuentre inicialmente acoplado \cpnote{La palabra
...
de qubits\cpnote{no es información arbitraria}. Un qubit es un sistema cuántico de dos niveles, 
