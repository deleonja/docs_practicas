...
de una operación cuántica. La CP es una condición más fuerte  \cpnote{No entiendo 
ese adjetivo acá} \janote{Mejor?}
a la de la positividad y que, en el contexto de la
mecánica cuántica y los sistemas abiertos, asegura que, aún 
cuando el sistema principal se encuentre inicialmente enlazado \cpnote{La palabra
no es acoplado sino enlazado. Acople se refiere a interaccion, como un hamiltoniano}
\janote{De acuerdo. Si tenía confundidos los términos}
...
sistemas cuánticos abiertos a interacción con su entorno. \cpnote{El
final de la frase está chueco} \janote{La parte de ``.. abiertos a interacción..''?}
...
tensoriales de las matrices de Pauli\cpnote{no es información arbitraria}
\janote{Ya.}. Un qubit es un sistema cuántico de dos niveles, 
...
\cpnote{Creo que la frase sobra, o por lo menos ese no es mi objetivo, sino 
mas bienpreparar el terreno para el caso de n qubits. reformula}
\janote{De acuerdo. Reformulé los últimos dos enunciados de este párrafo.
El resaltado se borra}
...
\cpnote{La redacción de este parrafo no me gusta y suena informal. Revisa}
\janote{Dale, con el párrafo que está antes reformulé}
