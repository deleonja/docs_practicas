...
sobre los ejes y la definición en \eqref{eq:PCE_definition} 
de una operación PCE. Los dos tipos de operaciones transforman de 
...
En el caso de 1 qubit, los canales PCE sí son un subconjutno de los \ruskai{}. Para $d=2$,
...
(ver \Fref{fig:2qubits_PCEChannels_figs}). Ya que probamos que los 
