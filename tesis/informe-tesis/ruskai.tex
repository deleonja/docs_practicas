...
de las matrices de dimensión $d\times d$ \cpnote{no
creo qeu el lector se acuerde de que es ese conjunto. Quiza lo puedes referenciar 
por nombre aca y luego en el cuerpo del capitulo mencionar el simbolo y el espacio, 
o referenciar donde se introdujo} \janote{Cierto. Mejor le pongo nombre y apellido
porque sería impráctico hacer la referencia hasta el capítulo 1.}
...
\cpnote{Me gusto mucho mas esta intro que la de la 3. }\janote{:D}
% }}}
