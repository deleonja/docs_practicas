...
Las rutinas se programaron en Wolfram Mathematica\footnote{\janote{dice JD
que, dado que la ECFM no paga licencias de Mathematica, es posible que digamos que 
la UNAM me proporcionó la licencia? O argumentar de alguna forma que 
no estoy usando software pirateado. Siempre puedo agregar a la UNAM en 
mis agradecimientos, no me molesta jajaja}}.
