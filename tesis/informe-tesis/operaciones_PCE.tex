...
El número de operaciones de este tipo crece de manera exponencial 
...
\cpnote{redaccion}
\janote{Quizás no entendí porqué la redacción estaba mal. Hice una 
corrección, pero si igual sigue mal por favor dime qué es lo que estoy 
diciendo mal.}. A las operaciones PCE que satisfacen 
...
las matrices 
vectorizadas de los productos tensoriales de las matrices de Pauli.
