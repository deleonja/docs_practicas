...
que satisface \eqref{eq:E(rho)} \cpnote{no entiendo que quieres decir que
no satisfaga 1.19\ldots quizá quieres decir que mapea estados a estados? O como?} pero que no es CP y, por consiguiente,
...
como se muestra en la \Fref{fig:qtm-op-motivation}\cpnote{Creo que quitaste la figura}. 
...
sería bueno escribir algo más?}\cpnote{Si estás de acuerdo, borrala. Se me hace
