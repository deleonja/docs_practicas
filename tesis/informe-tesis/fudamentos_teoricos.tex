...
en sistemas de muchas partículas\cpnote{La matriz de densidad es una
matriz, no una aplicación (en su manera más simple\ldots). Quizá te 
quieras referir a la traza parcial?}.
...
son cero o positivas, como esperaríamos que fuese. \cpnote{Siengo que la notación
$A\ge 0$ no es obvia. Quizá quieras decir en este párrafo que es. Lo dices 
implicitamente, pero creo qe hay que ser tantito mas explicito.}
...
total son separables \cpnote{Acá tenemos que hablar. Hay varios tipos de estados, 
los factorizables, los separables y los enlazados. Siento que no conoces la diferencia 
entre los primeros dos. Hablamos y corriges este parrafo por favor}, pues el
...
Ahora que mostramos la utilidad que puede tener la matriz de densidad
...
una matriz de densidad, en general, se sobreentiende}.
Un canal cuántico $\E$ es un mapeo afín de matrices de densidad y una
operación completamente positiva~\cite{bengtsson_zyczkowski_2017}\cpnote{Oye porque 
...
Un canal cuántico $\E$ es una operación que actúa sobre un estado 
cuántico $\rho$ como
...
estado de $S$ no lo conocemos \textit{a priori} \cpnote{a priori va separado, ya lo 
cambié}
...
la promesa anterior y acá explicar}
