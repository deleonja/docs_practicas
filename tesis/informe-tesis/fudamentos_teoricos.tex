...
\janote{Los siguientes dos enunciados fueron los que agregué para
aclarar lo de la matriz de densidad}
...
% \cpnote{La matriz densidad es una
...
% aplicación del formalismo de la matriz densidad. Reformulé 
% esa frase.}
...
\begin{itemize}
	...
	\end{equation}\janote{ojo aquí agregué la dependencia temporal de $U$}
