...
=\E^R_{\ind{mn}{\mu\nu}}
=D_{\ind{mn}{\mu\nu}}$.
Finalmente, para evaluar \cpnote{me parece que acá va ``determinar''
...
``evaluar''} que $\rho'$ sea una matriz de densidad positiva 
...
En este capítulo revisamos \cpnote{Creo que es un poco mucho decir que 
