...
de la matriz de densidad.\cpnote{La matriz de densidad es una
...
de traza es una operación lineal la traza parcial también lo es. \cpnote{Para que esta
definición esté completa, también tienes que decir que la traza parcial 
es lineal} \janote{De acuerdo. Hecho}
En sistemas 
...
Para exponer en una manera más concreta la necesidad de 
