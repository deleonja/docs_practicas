...
la introducción.}
\janote{Recuerdo que discutimos esto. Te mencioné que 
no podía quitar el título de la sección porque en el protocolo 
coloqué la introducción como una sección y así me lo aprobaron. Por 
esa razón será mejor dejar el título para evitar esas correcciones luego.}
\section{Introducción} % {{{
\janote{Iteración v2 de la introducción:}

El estudio de los sistemas cuánticos como sistemas que no
interactúan con su entorno nos ha permitido entender bastante bien los
...
sistemas cuánticos abiertos será necesario revisar un formalismo distinto
...
conforman al ensamble de estados del sistema $\{p_i, \ket{\psi_i} \}$. 
...
\cpnote{No veo la necesidad de meter dos bases ortogonales diferentes. }
\janote{De acuerdo. Dejé una}
...
realizar una medición. \cpnote{Reformula esta ultima frase. se me hace
que parece decir más de lo que realmente muestra la prueba} 
\janote{Hecho. Nueva iteración:}
...
con el vector de estado\cpnote{Esta frase la pondría
