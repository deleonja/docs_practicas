...
\cpnote{El titulo del capitulo o de la seccion?}
...
\cpnote{Cambie tantito la redacción para que quede claro que lo vamos a desarrollar en 
la seccion}

%obedecen una regla 
%para el número de componentes de Pauli que dejan invariantes y para la
%cantidad de canales PCE que hay por número de componentes de Pauli invariantes.
%
% con detalle el análisis de los resultados 
%de los canales PCE de 2 y 3 qubits presentados en las secciones anteriores. 
%Vamos a discutir cómo clasificar a los canales PCE y sobre las propiedades 
%que comparten. 
%
...
\janote{Cierto. Agregué el párrafo que está antes de tu comentario.}
...
\janote{Parece que sí estaba cansado... creo que ya estaba harto (mamado
en colombiano, a verga en chapín) de escribir XD}
\begin{enumerate}
	...
	invariantes por el canal, es simétrico respecto a $k=n$\cpnote{No se entiende. Que tal si le das una revisada a la redaccion cuando andes descansado a lo que queda de esta seccion?}
	\janote{Ahora mejor?}. 
