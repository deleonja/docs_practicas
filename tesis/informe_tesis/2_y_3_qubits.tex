...
%Las características que muestran nuestros resultados de los 
%canales cuánticos de 2 y 3 qubits son muy específicas, 
%que al examinar el caso de 1 qubit no parecen obvias ni, mucho menos, 
%particulares de los canales PCE en general. 
% \cpnote{Primera frase chafa. Itera estos parrafos de nuevo, pues sospecho
% que estabas cansado.}
% \janote{Nota por favor que elaboro la idea en todo el párrafo y la idea principal 
% debe ser el último enunciado.}
%Quizás el rasgo menos evidente 
%en el caso de 1 qubit es la clasificación que se puede hacer en
%subconjuntos cuyos elementos son equivalentes vía dos operaciones unitarias. 
%Por otro lado, otra característica de los canales PCE es que obedecen dos reglas, 
%una específica que un canal PCE debe preserva sólo potencias de dos 
%componentes de Pauli invariantes, y la otra regla establece una simetría,
%respecto a $k=n$, del número de canales PCE en función del exponente $k$
%de las $2^k$ componentes de Pauli que deja invariantes. Al examinar 
%de nuevo la \Tref{tab:1qubit_PCE} comprobamos que, efectivamente, 
%los canales PCE de 1 qubit tienen estas características. Sin embargo, 
%no habrían podido ser evidentes sino hasta examinar los casos de 2 y 3 qubits
%las características propias de los canales PCE. 

En este capitulo presentaremos los resultados anteriores.
...
\Fref{fig:2qubits_PCEChannels_figs} proporcionan intuición de 
que una estructura matemática subyacente de los canales PCE es evidente.
%\cpnote{mas conservador}
%\cpnote{no me gusta la frase, reformula de manera mas profesional}\janote{listo}
%Es como si los canales PCE, en esta representación
%geométrica, gritasen  por si solos que obedecen una
...
%comparten los canales PCE a partir de las listas de 1 y 0, se nos ocurrió 
...
de 1 y 0 de los canales PCE de 1 qubit en la \Tref{tab:1qubit_PCE}.  
