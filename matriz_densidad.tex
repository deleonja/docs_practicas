...
%, por consiguiente
%\begin{align}
%\bra{\psi_i}\ten\bra{\phi_j}\Lambda_A\ket{\psi_k}\ten\ket{\phi_l}&=
%\matrixel{\psi_i}{\Lambda_A}{\psi_k}\braket{\phi_j}{\phi_l}\\
%	&=\matrixel{\psi_i}{\Lambda_A}{\psi_k}\delta _{jl}.
%\end{align}
...
\end{align}
%Notemos entonces que para obtener la información física de un observable
%que actúa sobre un subsistema que forma parte de un sistema compuesto
%se introdujo la herramienta del operador de densidad reducido. De hecho,
