...
cuánticos físicos. \cpnote{Corregir redaccion}. \janote{Hecho.}
...
$\mathcal{H}_{\text{total}}$. \cpnote{Te propondria reemplaar esa ecuacion por una ecuacion que haga el
...
\cpnote{Quitaria esa ultima frase} \janote{Mejor reescribí toda la subsección.}
...
\janote{Ahora lo definí en el último párrafo de la subsección 3.3, es suficiente o
es necesaria una ecuación?}
\end{itemize}
