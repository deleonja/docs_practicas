...
qubits ($2^{2^n-1}$) \cpnote{Esto es exponencial, no doblemente exponencial. Ademas, dos a
la seis no es 10 a la 18. Creo qeuaca hay un prlblema}\janote{Error mío jeje, ahora sí.
Sí es doblemente exponencial ahora, no?}. Para $n=3$ el número de 
