...
{\large \h{xx de enero de 2021}} % Date, change the \today to a set date if you want to be precise                                                              
...
\input{formalidades}
\input{matriz_densidad}
\input{operaciones_cuanticas}
\input{projective_maps}
\input{conclusions}
